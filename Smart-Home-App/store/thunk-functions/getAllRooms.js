    ...
    rooms.push(
        new Room(
            ...
            [
                ...
                new Device('temp2', 'temp sensor', 'sensor 1', { value: '32', unit: 'Celsius' }),
                new Device('light2', 'light sensor', 'sensor 2', { value: '500', unit: 'Lux' })
            ]
        ),
        new Room(
            '3',
            ...
            [
                ...
                new Device('temp3', 'temp sensor', 'sensor 1', { value: '32', unit: 'Celsius' }),
                new Device('light3', 'light sensor', 'sensor 2', { value: '500', unit: 'Lux' })
            ]
        ),
        new Room(
            '4',
            ...
            [
                ...
                new Device('temp4', 'temp sensor', 'sensor 1', { value: '32', unit: 'Celsius' }),
                new Device('light4', 'light sensor', 'sensor 2', { value: '500', unit: 'Lux' })
            ]
        ),
        new Room(
            '5',
            ...
            [
                ...
                new Device('temp5', 'temp sensor', 'sensor 1', { value: '32', unit: 'Celsius' }),
                new Device('light5', 'light sensor', 'sensor 2', { value: '500', unit: 'Lux' })
            ]
        ),
        new Room(
            '6',
            ...
            [
                ...
                new Device('temp6', 'temp sensor', 'sensor 1', { value: '32', unit: 'Celsius' }),
                new Device('light6', 'light sensor', 'sensor 2', { value: '500', unit: 'Lux' })
            ]
        ),
    )
